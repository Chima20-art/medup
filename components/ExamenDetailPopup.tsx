...
const ExamenDetailPopup: React.FC<ExamenDetailPopupProps> = ({
  ...
  console.log("typeof audioNotes ", typeof examen.audioNotes);

  let audioNotes: string[] = Array.isArray(examen.audioNotes)
    ? examen.audioNotes
    : [];

  console.log("audioNotes ", examen.audioNotes);
          ...
          <View className="border border-gray-200 rounded-xl p-2 mx-auto w-[80%]">
            ...
            <View className="flex flex-col gap-y-3">
              ...
              <Text className="font-bold text-gray-700">
                {examen.labName || "Laboratoire non spécifié"}
              </Text>
              <Text className="text-gray-700">
                {examen.phone || "Téléphone non disponible"}
              </Text>
            </View>
          </View>
            ...
            {audioNotes.length > 0 && (
              <View className="mb-4">
                {audioNotes.map((audio: string) => (
                  ...
                  >
                    <SupabaseAudioPlayer bucket={bucket} audioNote={audio} />
                  </View>
                ))}
              </View>
            )}
