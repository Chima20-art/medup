          ...
          <View className="flex-1 px-6 pt-10">
            ...
            <View className="flex flex-column gap-y-2 mb-6 w-full">
              ...
              >
                ...
                <Text className="text-white text-base font-semibold ml-2">S'inscrire avec email</Text>
              </TouchableOpacity>
            </View>
            ...
            <Text className="text-center text-white/70 text-sm mb-6">
              ...
              <Text className="underline font-bold">Conditions d'utilisation</Text> et notre{" "}
