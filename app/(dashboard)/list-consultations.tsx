...
import { View, Text, TextInput, TouchableOpacity, SafeAreaView, Animated } from 'react-native'
...
export default function ListConsultations() {
    ...
    const handleConsultationPress = useCallback(async (consultation: Consultation) => {
