                        ...
                        <View className="bg-white rounded-xl mb-4 overflow-hidden shadow-sm">
                            <View className="flex-row p-4">
                                ...
                                <View className="items-center mr-4">
                                    ...
                                    <Text className="text-xs font-medium mt-1">{new Date(radio.date).getDate()}</Text>
                                    <Text className="text-xs">{new Date(radio.date).toLocaleString('default', { month: 'short' })}</Text>
