        ...
        <View className="flex-1 bg-gray-50 pt-4">
            <View className="px-6 pt-14 pb-2 bg-white">
                <View className="flex-row items-start">
                    ...
                    <Text className="text-primary-500 text-2xl font-extrabold ml-4">Ajouter un examen {`\n`} radiologique</Text>
                    <RadioCategory/>
                </View>
            ...
            >
                <ScrollView className="flex-1 p-6">
                    <View className="gap-y-4">
                        {/* Name/Type Input */}
                        <View>
                            <Text className="text-md font-medium text-gray-700 mb-1">Nom / Type</Text>
                        ...
                        {/* Date Input */}
                        <View>
                            <Text className="text-sm font-medium text-gray-700 mb-1">Date de réalisation</Text>
                            <TouchableOpacity
